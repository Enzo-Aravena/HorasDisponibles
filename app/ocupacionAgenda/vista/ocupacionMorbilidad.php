...
<link href="../../../lib/css/bootstrap.min.css" media="all" rel="stylesheet" type="text/css" />   
  ...
  <body>
	...
	<div class="modal-shiftfix" id="morbilidad">
      <!-- Navigation -->
      <div class="navbar" style="height:8%;border:none;">
         <div class="container-fluid main-nav clearfix">
		    ...
		    <div class="heading" style="    margin-left: 2%;"> 
		    	<img src="../../../lib/images/diary.png" width="26px">
   				<label style="margin-left: 1%;">Ocupación Morbilidad </label>
		    </div>
        ...
        <div class="form-group">
          ...
          <div class="col-md-3 bordes" style="margin-left: 1%;    height: 47px;">                      
                <label class="control-label col-md-2"  style="margin-top: 10px;width: 23%;"> Actos Tabla </label>
                <div class="col-md-7">
                <label class="radio-inline">
                  <input style="cursor: pointer;" checked="" name="rdbBuscar" type="radio" value="mort"><span> MORBT</span>
                </label>    
                <label class="radio-inline">
                  <input style="cursor: pointer;" name="rdbBuscar" type="radio" value="morb"><span> MORBI</span>
                </label>                              
                </div>
