	...
	case 'cargarTabla':
		...
		//echo $fecha1." ".$fechaTitulo;
			...
			// TITULO PRINCIPAL
				...
				$array = array(325,281,238,182,146,147,1,1.319);
	...
	case 'exportarArchivo':
		...
		if ( $fecha1 == "" || $fecha1 == 0 || isset($$fecha1) ) {
			...
			echo "<table>";
				...
				$progSemanal = array(1623,1403,1191,910,730,735,6592);
				echo "<tr>";
				echo "<td colspan='3' style= 'background: #BAC4FF;font-weight: bolder;'>Programado diario (Estimacion total anual/ dias habiles)</td>";
				foreach ($array as $valor) {
