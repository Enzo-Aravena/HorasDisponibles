	...
	var data= {
		...
		$.ajax({
			...
			success:function(response){	
				...
				$('#semana').empty();
				$("#semana").append('<option value=0 selected="selected">______Total Acumulado 2023______</option>');
	...
	$.getJSON("../controlador/servidor/controladorCampana.php",data, function(json) {
   	...
   	var options = {
		...
		series: [		
			{ 
				id :2,		
				name: 'Total Atenciones de Morbilidad (contiene las respiratorias) 2022',
			...
			{
			 	id :1,	
				name: 'Total Atenciones de Morbilidad (contiene las respiratorias) 2023',
	                    data: V_TOTAL_CESFAM,
						color: {
	                linearGradient : {
	                    x1: 0,
			...
			{ 
				id :2,
				name: 'Total Atenciones por causa Sistema Respiratorio 2022',
				data: V_TOTAL_SR_AA,
				color: {
					linearGradient : {
						x1: 0,
        	...
        	{
				id :1,
				name: 'Total Atenciones por causa Sistema Respiratorio 2023',
				data: V_TOTAL_SR,
				color: {
					linearGradient : {
						x1: 0,
