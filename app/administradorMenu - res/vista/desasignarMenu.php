...
<link href="../../../lib/css/bootstrap.min.css" media="all" rel="stylesheet" type="text/css" />   
	...
	<script src="js/desasignar.js"></script>
		  ...
		  <div class="col-md-12">
		    <div class="widget-container">
		       <div class="heading">
			        ...
			        <label style="margin-left: 1%;"> Desasignar Menu</label>
		       </div>
		        ...
		        <div class="widget-content padded">
			        	...
			        	<div class="form-group">
				            ...
				            <div class="col-md-3">
	   		          	...
	   		          	<div style="margin-left: 38%;">
			       			<br>		       		
			       			<button class="btn btn-primary" id="desasignar">Desasignar</button> 		       				       		
		        	...
		        	<div class="form-horizontal"  id="AsignadoCorrecto">
		        		<div class="col-md-3 mostrarForm" style="margin-top: 2em; margin-left: -1%;">
		        			<label class="textoSuccess"> Se ha Desasignado el menu correctamente</label>	
			        	</div>       	
