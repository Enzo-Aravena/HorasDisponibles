				      		...
				      		<div class="row">
              					<div class="col-md-3">
              						<div class="form-group">
              							<label for="semana">Semana Epidemiologica</label>
              					...
              					<div class="col-md-6">
              						<div class="form-group">
              							...
              							<div class="col-md-12">
											...
											<label class="radio-inline">
												<input name="centro" type="radio" id="stats-sites-6" value="13" onClick="enviarDatosFormulario()">
												<span>L.T</span>
											</label>
										</div>
              						</div>
              						<div class="form-group" id="visualizador">
										<label  style="margin-left: 1%;" class="checkbox-inline">
											<input type="checkbox" name="visualizar_dia" id="visualizar_dia" value="1"><span>POR DIA </span>
										</label>
