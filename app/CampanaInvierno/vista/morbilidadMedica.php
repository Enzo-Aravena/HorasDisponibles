...
<head>
	...
	<link href="css/estilomorbMed.css" media="all" rel="stylesheet" type="text/css" />
	...
	<script src="js/navMorbiMedica.js"></script>
</head>
	<body>
			...
			<div class="modal-dialog">
				<div class="modal-content">
					<div class="modal-header" style="background: #007aff;">
						<h4 class="modal-title" style="color:white;">Morbilidad Medica</h4>
					</div>
