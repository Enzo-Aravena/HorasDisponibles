		...
		if ($count == "0") {
			...
			while ($fila = mysqli_fetch_row($resultado)) {
				$data[$i]= Array(
					...
					"codigo" => utf8_encode($fila[2]),
					"material" => mb_strtolower(utf8_encode($fila[3])),
					"stockInicial" => utf8_encode($fila[4]),
					"nDeIngresos" => utf8_encode($fila[5]),
					"totalDispensadas" => utf8_encode($fila[6]),
					"totalEgresos" => utf8_encode($fila[7]),
					"stockFinal" => utf8_encode($fila[8]),
					"maximo" => utf8_encode($fila[9]),
					"critico" => utf8_encode($fila[10]),
					"estado" => utf8_encode($fila[11]),
					"solicitar" => utf8_encode($fila[12])
				); // End Array
				$i++;
			}// end while
		}// end else
